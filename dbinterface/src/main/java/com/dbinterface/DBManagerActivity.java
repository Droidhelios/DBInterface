package com.dbinterface;//add your package name here example: package com.example.dbm;
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainscrollview = new ScrollView(DBManagerActivity.this);
        ...
        mainLayout = new LinearLayout(DBManagerActivity.this);
        ...
        select_table = new Spinner(DBManagerActivity.this);
        ...
        hsv = new HorizontalScrollView(DBManagerActivity.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(DBManagerActivity.this);
        previous = new Button(DBManagerActivity.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(DBManagerActivity.this);
        next.setText("Next");
        ...
        final Button customQuery = new Button(DBManagerActivity.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DBManagerActivity.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DBManagerActivity.this,
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DBManagerActivity.this)
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(DBManagerActivity.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DBManagerActivity.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DBManagerActivity.this);
    ...
    public void updateDeletePopup(int row) {
        ...
        final RelativeLayout lp = new RelativeLayout(DBManagerActivity.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(DBManagerActivity.this);
        LinearLayout lcrud = new LinearLayout(DBManagerActivity.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(DBManagerActivity.this,
